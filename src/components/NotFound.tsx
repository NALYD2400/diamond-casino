    ...
    >
      ...
      <section className="relative z-10 flex flex-col items-center text-center max-w-[500px] px-6 gap-6 sm:gap-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-4 w-full justify-center">
          <button
            onClick={onReturn}
            className="bg-white text-black font-semibold px-8 py-3.5 rounded-full hover:bg-neutral-200 transition-colors uppercase tracking-wider text-xs flex items-center justify-center gap-2 cursor-pointer"
          >
            <RefreshCw size={14} /> Return to Landing
          </button>
          <button
            onClick={onReturn}
            className="liquid-glass px-8 py-3.5 rounded-full text-white text-xs font-semibold uppercase tracking-wider hover:bg-white/10 transition-colors text-center cursor-pointer"
          >
            Explore Features
          </button>
        </div>
